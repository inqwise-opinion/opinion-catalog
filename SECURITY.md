...
The opinion-catalog service follows semantic versioning. We actively support the
...
- [![Known Vulnerabilities](https://snyk.io/test/github/inqwise-opinion/opinion-catalog/badge.svg)](https://snyk.io/test/github/inqwise-opinion/opinion-catalog)
...
When integrating opinion-catalog:

### Recommended Practices

1. Keep dependencies updated and monitor release notes.
2. Validate input to APIs that wrap opinion-catalog utilities.
...
2. Enforce request rate limits if catalog endpoints are public.
3. Configure observability to detect misuse or anomalies.

## Dependency Security

Production and test dependencies are monitored through the scans listed above.
